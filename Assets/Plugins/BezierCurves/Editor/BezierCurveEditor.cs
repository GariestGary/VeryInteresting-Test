...
namespace BezierCurves
{
	...
	public class BezierCurveEditor : Editor
	{
		...
		void DrawPointInspector(BezierPoint point, int index)
		{
			...
			int newType = (int) ((object) EditorGUILayout.EnumPopup("Handle Type",
		...
		static void DrawPointSceneGUI(BezierPoint point)
		{
			...
			if (point.handleStyle != BezierPoint.HandleStyle.None)
			{
				...
				Vector3 newGlobal1 = Handles.FreeMoveHandle(point.globalHandle1, point.transform.rotation,
				...
				Vector3 newGlobal2 = Handles.FreeMoveHandle(point.globalHandle2, point.transform.rotation,
